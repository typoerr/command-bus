...
export declare type CommandTargetResult<T> = T extends string ? AnyCommand : T extends AnyCommandCreator ? ReturnType<T> : T extends AnyCommandCreator[] ? ReturnTypeByArray<T> : never;
